...
export default function Home() {
  return (
    <>
      <Helmet>
        <title>
          Global Réno | Rénovation écologique toiture, façade et isolation
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Global Réno | Rénovation toiture, façade, isolation"
        />
        <meta
          property="og:description"
          content="Faites confiance à Global Réno pour des rénovations durables et certifiées RGE dans le Grand Ouest. Toiture, façade, isolation thermique."
        />
        <meta
          property="og:image"
      ...
      <div className="flex flex-col md:flex-row justify-around items-center   px-4">
        <div className="bg-gray-400 rounded-lg p-4 w-full md:w-[40%] mb-5">
          <p className="text-sm md:text-base text-justify break-words">
            ...
            votre habitat. <br /> Spécialistes de la rénovation de toiture, de
            façade et de l’isolation extérieure, <br />
            nous vous accompagnons dans vos projets avec des solutions durables,
            esthétiques et performantes. <br /> 🏡 Redonnez vie à votre maison
            tout en améliorant son confort et sa valeur. <br /> Nos équipes
            certifiées interviennent avec rigueur et professionnalisme, dans le
            respect des normes françaises et européennes, pour garantir des
            résultats à la hauteur de vos attentes. <br />
            👉 Faites le choix de la qualité et de la tranquillité avec Global
            Reno.
          </p>
        </div>
