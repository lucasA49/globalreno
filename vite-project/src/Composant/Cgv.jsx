      ...
      <div className="bg-gray-200  shadow-lg rounded-md w-full max-w-4xl p-8  ">
        ...
        <div className="flex flex-col w-full flex text-center">
          ...
          <p className="text-gray-600">
            ...
            <br />
            <br />
            <strong>2. Objet du site</strong>
            <br />
            Le site internet de Global Reno a pour objet de présenter les
            activités de l'entreprise, à savoir la rénovation de l'habitat,
            ainsi que de fournir des informations et des services associés.
            <br />
            <br />
            ...
            <br />
            <br />
            <strong>4. Absence de cookies</strong>
            <br />
            Le site internet de <strong>Global Reno</strong> ne collecte pas de
            cookies ni de données personnelles à des fins de suivi
            comportemental ou publicitaire. Nous nous engageons à respecter
            votre vie privée en ne traitant aucune information vous concernant
            ...
            recopie, la reproduction, la modification ou la distribution des
            contenus) entraînera des poursuites judiciaires.
            <br />
            <br />
            ...
            <br />
            <br />
            <strong>8. Sanctions en cas de violation</strong>
            <br />
            Toute tentative de recopie, d'utilisation ou d'exploitation non
            autorisée des contenus du site, y compris toute tentative de
            piratage ou d'atteinte à la sécurité du site, entraînera des
            poursuites civiles et pénales, conformément aux lois en vigueur,
            notamment la loi n° 98-536 du 1er juillet 1998 relative à la
            protection des droits d'auteur et des droits voisins dans la société
            de l'information.
            <br />
            <br />
            <strong>9. Loi applicable</strong>
            <br />
            ...
            social de <strong>SASU Global Reno</strong>, sauf disposition légale
            contraire.
            <br />
            <br />
            <strong>10. Modification des CGU</strong>
            <br />
            <strong>SASU Global Reno</strong> se réserve le droit de modifier à
            tout moment les présentes CGU, notamment pour les adapter à des
            évolutions législatives, réglementaires ou techniques. Toute
            modification sera publiée sur cette page, et vous serez informé des
            mises à jour.
            <br />
            <br />
            ...
            leurs activités, sous réserve que cela soit fait dans le respect des
            lois en vigueur. Nous nous engageons à ne pas revendre vos
            informations à des tiers sans votre consentement explicite.
            <br />
          </p>
